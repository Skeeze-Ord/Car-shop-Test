...
namespace Shop2.Migrations
{
    ...
    [Migration("20220506095048_Orders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shop2.Data.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Shop2.Data.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Shop2.Data.Models.OrderDetail", b =>
                {
                    b.HasOne("Shop2.Data.Models.Car", "Car")
                        .WithMany()
                        .HasForeignKey("CarID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Shop2.Data.Models.Order", "Order")
